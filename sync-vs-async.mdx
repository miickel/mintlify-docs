...
**Endpoint:** `POST /api/v1/renderers/pdf` 🔗 [API reference](/api-reference/render-a-pdf-synchronously)
...
**Endpoint:** `POST /api/v1/renderers/pdf/async` 🔗 [API reference](/api-reference/render-a-pdf-asynchronously)
