...
## Checking credit usage via API

You can also retrieve your credit usage details programmatically through our API.
[API reference](/api-reference/credits/get-credits-usage)
